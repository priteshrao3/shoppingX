...
class CustomerRegistrationForm(UserCreationForm):
    ...
    password2 = forms.CharField(label='Confirm Password (agein)',widget=forms.PasswordInput(attrs={'class':'form-control'}))
...
class MyPasswordResetForm(PasswordResetForm):
    ...
    max_length=250, widget=forms.EmailInput(attrs={'autocomplete':'email', 'class':'form-control'}))
